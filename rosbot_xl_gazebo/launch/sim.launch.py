...
def generate_launch_description():
    ...
    xacro_file = os.path.join(rosbot_xl_description, "urdf", "rosbot_xl.urdf.xacro")
    ...
    joint_state_bridge = Node(
        ...
        arguments=[
            "/world/empty/model/rosbot_xl/joint_state"
            + "@sensor_msgs/msg/JointState"
            + "[ignition.msgs.Model"
        ],
        remappings=[("world/empty/model/rosbot_xl/joint_state", "joint_states")],
        output="screen",
    )
