...
protected:
  ...
  realtime_tools::RealtimeBox<std::shared_ptr<Float64MultiArray>>
    received_motor_state_msg_ptr_{nullptr};

  std::shared_ptr<rclcpp::Publisher<Float64MultiArray>>
    motor_command_publisher_ = nullptr;
    
  std::shared_ptr<realtime_tools::RealtimePublisher<Float64MultiArray>>
    realtime_motor_command_publisher_ = nullptr;

  rclcpp::Subscription<Float64MultiArray>::SharedPtr
    motor_state_subscriber_ = nullptr;
